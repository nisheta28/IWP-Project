              ...
              <form role="form" method="post" action="loginCheck.php">
                  <div class="row">
                      ...
                      <label for="username"><span class="text-danger" style="margin-right:5px;">*</span>Username:</label>
                          <div class="input-group">
                              <input class="form-control" id="username" type="text" name="username1" placeholder="Username" value="<?php echo @$_COOKIE['cid'];?>"required/>
                  ...
                  <div class="row">
                      <div class="form-group col-xs-12">
                          ...
                          <div class="input-group">
                              <input class="form-control" id="password" type="password" name="password" placeholder="Password" value="<?php echo @$_COOKIE['cpass'];?>" required/>
                              <span class="input-group-btn">
                 ...
                 <br><br>
                         ...
                         <a href="index.php">Admin</a><br>
                          ...
                          <a href="nologincharity.php">Guest User</a>
                      </div>
                  </div>
              </form>
          </div>
